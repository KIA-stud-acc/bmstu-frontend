    ...
    <Table className="w-100" responsive="sm">
        ...
        {application.map((item)=> (
                      <><tr onClick={()=>navigate(`/bmstu-frontend/applications/${item.id}`)}> 
                        ...
                        <td>{item.creator}</td>
                        <td>{item.date_of_creation? item.date_of_creation.slice(0,19).replace('T','\n'): "-"}</td>
                        <td>{item.date_of_formation? item.date_of_formation.slice(0,19).replace('T','\n'): "-"}</td>
                        <td>{item.date_of_completion? item.date_of_completion.slice(0,19).replace('T','\n'): "-"}</td>
                        <td className='desc'><div className="descDiv">{item.description || "-"}</div></td>
